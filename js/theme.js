/**
 * Customize the application using this file
 */

//  Timings and Distance
const simulationInterval = 500 //  In ms.  Interval between each lat/lng sent in a PN signal.  Recommend 500 to 5000
const minimumSpawnDistanceOfDriver = 3000 //  In meters.  A delivery driver will spawn when summoned at a distance from the delivery location as the crow flies
const maximumSpawnDistanceOfDriver = 5000 //  In meters.  A delivery driver will spawn when summoned at a distance from the delivery location as the crow flies

//  Colours of the route (lines) displayed on the Google Map
const theme_routeColours = [
  '#FF0000', //  Package Delivery
  '#FF00FF', //  Rideshare
  '#0000FF' //  Food Delivery
]
//  Colours of the driver markers (car, bike) on the Google map
const theme_driverIconColours = [
  '#000000', //  Package Delivery
  '#000000', //  Rideshare
  '#000000' //  Food Delivery
]

//  Icons themselves, expressed as SVG.  Although Google maps supports images, this application assumes markers are specified as SVG files.  If you want to use images, change how the icon is specified in map.js, https://developers.google.com/maps/documentation/javascript/markers#simple_icons
const truck_svg =
...
//  Index in this array corresponds to the constants for package delivery, taxi and food delivery respectively
const theme_driverIcons = [truck_svg, taxi_svg, bike_svg]

//  Constants - please do not change these or add more constants
const THEME_PACKAGE_DELIVERY = 0
const THEME_TAXI = 1
const THEME_FOOD_DELIVERY = 2
